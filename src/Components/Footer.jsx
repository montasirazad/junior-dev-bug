...
import { Ameraca, Bkash, Call, CustomerSp, DutchBangla, Location, Logo, MasterCard, Nagad, Paypal, Rocket, Visa } from '../Assets/index'
            ...
            <div className="ml-auto mr-auto container grid grid-cols-12 gap-x-11 border-b border-white border-opacity-10 pb-12 ">
                ...
                <div className="col-span-3 space-y-8">
                    ...
                    <div className="grid grid-cols-4 gap-2">
                        {Payments.map((data) => (
                            <div key={data.id}>
                                <img src={data.image} className="w-full h-auto object-cover" alt="" />
